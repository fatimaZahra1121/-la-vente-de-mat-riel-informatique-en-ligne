...
.gridView .cell-label {
  opacity: 0.6;
    ...
    function W3docs()                                    
    { 
        var nom= document.forms["form"]["prod"];               
        var url = document.forms["form"]["url"];  
        var qt= document.forms["form"]["price"];               
        var pric = document.forms["form"]["qte"];  
        document.getElementById ("ver").innerHTML="Remplire tous les champs!!";
        if (nom.value == "" || url.value == "" || qt.value == "" || pric.value == ""    )                                   
        { 
  ...
  <div class="app-container">
    ...
    <p>Material.Net</p>
      ...
      <div class="form-container">
                    <h3 class="title">Ajouter</h3>
                    <form  action="gestionP1" method="post" class="form-horizontal" name="form" onsubmit="return W3docs()">
                        <div class="form-group">
                            <label>Nom</label>
                            <br> <br>
                            <input type="text" name="prod" class="form-control" placeholder="le Nom de produit">
                        </div>
                        <div class="form-group">
                            <label>Url</label>   <br> <br>
                            <input type="text" name="url" class="form-control" placeholder="lien de l'image">
                        </div>
                        <br>                        <br>                        <br>
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" name="qte" class="form-control" placeholder="Quantite">
                        </div>
                                                <br>                        <br>                        <br>
                        ...
                        <div class="form-group">
                           ...
                           <textarea rows = "50" cols = "50" name="descrip" class="form-control" placeholder="Description">   </textarea>
                        </div>
         <p id="ver"></p>
