        ...
        <li class="sidebar-list-item">
         <a href="gestionUser.jsp">
            <span>Comptes</span>
                    ...
                    <form  action="gestionP1" method="get" class="form-horizontal">
                        <div class="form-group">
                            <label>Nom</label><br><br>
                            <%gestionProduit m=new gestionProduit();
                            String id=request.getParameter("idm");
                    		int i=Integer.parseInt(id);
                    		produit p=m.getproduit(i);
                    		%>
                            <input type="text" name="prod" class="form-control" placeholder="le Nom de produit" value=<%=p.getNom() %>>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control" placeholder="Prix" value=<%=p.getPrice() %>>
                        </div>
                          <div class="form-group">
                            <label>Stock</label><br><br>
                 <input type="number" name="stock" class="form-control" placeholder="Prix" value=<%=p.getStock() %>>
                        </div>
                 		...
                 		{
                 			if(p1.getId()==p.getIdc()){
                 			%>
                 		
                            <option selected><%=p1.getNom() %></option>
                            <%}
                 			else%>
                        ...
                        <div class="form-group">
                           ...
                           <textarea rows = "50" cols = "50" name="descrip" class="form-control" placeholder="Confirm Password">   </textarea>
                        </div>
