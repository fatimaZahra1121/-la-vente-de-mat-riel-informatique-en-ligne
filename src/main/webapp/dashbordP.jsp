  ...
  <div class="app-container">
    ...
    <div class="app-content">
      <div class="app-content-header">
       ...
       <a href="AjouterProdDash.jsp"><button class="app-content-headerButton">Ajouter Produit</button></a> 
      </div>
      <div class="app-content-actions">
      <form action="gestionP1" method="get">
            ...
            <div class="filter-menu">
              ...
              <select name="forma" onchange="location = this.value;">
                   ...
                   <option>Aucun</option>
                 		...
                 		list1=m.getListcategorie();
                 		
                 		for(categorie p1:list1)
                 		{ %>
                 		
                         <option value="gestionP1?nom1='<%=p1.getNom() %>'"><a href="/gestionP1.java"><%=p1.getNom() %></a></option>
              ...
              <select name="forma" onchange="location = this.value;">
       <option>Aucun</option>
               <option value="gestionP1?etat1='rep'"><a href="/filtre.java">En repture</a></option>  
                <option value="gestionP1?etat='stock"><a href="/filtre.java">En stock</a></option>
      ...
      if(l.size()==0)
      out.println("   <span id='aucun'>Aucun produit enregistrer,<a href='AjouterProDash.jsp'>voules-vous ajouter !!</a> </span>");
      else
      {
      %>
      ...
      <div class="products-area-wrapper tableView">
        <div class="products-header">
          ...
          <div class="product-cell status-cell">Sales<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
          <div class="product-cell sales">Stock<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
          <div class="product-cell stock">prix<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
...
String nom=p.prodCta(p1.getId());
int sales=p.sales(p1.getId());
 ...
 %>
        ...
        <div class="products-row">
          ...
          <div class="product-cell image">
            <img src="<% out.println(p1.getUrl());%>" alt="product">
            <span><% out.println(p1.getNom());%></span>
          </div>
          <div class="product-cell category"><span class="cell-label">Category:</span><% out.println(nom);%></div>
          
          <div class="product-cell sales"><span class="cell-label">Sales:</span><% out.println(sales);%></div>
          <div class="product-cell stock"><span class="cell-label">Stock:</span><% out.println(p1.getStock());%></div>
          <div class="product-cell price"><span class="cell-label">Price:</span><% out.println(p1.getPrice());%>DH</div>
          <div class="product-cell status-cell">
            <span class="cell-label">Action:</span>
            <span class=""><ul><li>  <%out.println("<a href='gestionP1?ids="+p1.getId()+"'>Suprimmer</a>");%></li>
<li>  <%out.println("<a href='gestionP1?idm="+p1.getId()+"'>Modifier</a>");%></li></ul></span>
          </div>
        </div>
        <%} %>
      </div>
