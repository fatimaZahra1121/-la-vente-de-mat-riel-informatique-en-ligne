  ...
  <div class="app-container">
    ...
    <div class="app-content">
      <div class="app-content-header">
        <h1 class="app-content-headerText">Detail de Commande</h1>
...
System.out.println("id de commande"+id);
int Id=Integer.parseInt(id);
gestionProduit m=new gestionProduit();
gestionCommande m1=new gestionCommande();
l=m1.getCommandeProd(Id);
for(produit p:l){
System.out.println("id sales"+p.getId());
int sales=m.sales(p.getId());
 ...
 %>
        ...
        <div class="products-row">
          ...
          <div class="product-cell stock"><span class="cell-label">Stock:</span><% out.println(p.getStock());%></div>
           <div class="product-cell stock"><span class="cell-label">Quantite:</span><% out.println(p.getQte());%></div>
          <div class="product-cell price"><span class="cell-label">Totale:</span><% out.println(p.getPrice());%>DH</div>
