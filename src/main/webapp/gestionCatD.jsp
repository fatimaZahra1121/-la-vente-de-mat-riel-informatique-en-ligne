...
<body>
  ...
  <div class="app-container">
    ...
    <div class="app-content">
      <div class="app-content-header">
       ...
       <a href="AjouterCat.jsp"><button class="app-content-headerButton">Ajouter Categorie</button></a> 
      </div>
      <div class="app-content-actions">
      <form action="gestionC1" method="post">
        <input name="mc" class="search-bar" placeholder="Search..." type="text" ></form>
        <div class="app-content-actions-wrapper">
          <div class="filter-button-wrapper">
            <div class="action-button filter jsFilter" id="m"></div>
      ...
      if(Mc!=null)
      {
    	l=m.getCategorieParMc(Mc); 
      }
      else
      l=m.getListcategorie();
      if(l.size()==0)
    	  out.println("   <span id='aucun'>Aucun Categorie enregistrer,<a href='AjouterCat.jsp'>voules-vous ajouter !!</a> </span>");
      else{
      %>
     ...
     <div class="product-cell price">Nombre des produits<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
  ...
  for(categorie p:l){
	  gestionProduit pr=new gestionProduit();
int count=pr.countproduct(p.getId());
 %>
        ...
        <div class="products-row">
          ...
          <div class="product-cell image">
            <img src="<% out.println(p.getUrl());%>" alt="product">
            <span><% out.println(p.getNom());%></span>
          </div>
          <div class="product-cell category"><span class="cell-label">ID:</span><% out.println(p.getId());%></div>
          
          <div class="product-cell sales"><span class="cell-label">Nombre des produit:</span><% out.println(count);%></div>
 
          <div class="product-cell status-cell">
            <span class="cell-label">Action:</span>
            <span class=""><ul><li>  <%out.println("<a href='gestionC1?ids="+p.getId()+"'>Suprimmer</a>");%></li>
<li>  <%out.println("<a href='gestionC1?id="+p.getId()+"'>Modifier</a>");%></li></ul></span>
          </div>
        </div>
        <%} %>
      </div>
