 ...
 %>
  ...
  <div class="app-container">
    ...
    <div class="app-content">
      ...
      <form action="gestionCom" method="post">
        <input name="mc" class="search-bar" placeholder="Search..." type="text" ></form>
        <div class="app-content-actions-wrapper">
          <div class="filter-button-wrapper">
            <div class="action-button filter jsFilter" id="n"></div>
      ...
      <%  gestionCommande m=new gestionCommande();
List<commande> l=new ArrayList<commande>();
String chercher=request.getParameter("mc");
int i=0;
if(chercher!=null)
{
	l=m.chercherCom(chercher);
	i=1;
}
if(i==0)
l=m.getCommandes();
System.out.println("size commande"+m.getCommandes().size());
if(l.size()==0)
      out.println("   <span id='aucun'>Aucun Commandes effectues !!</a> </span>");
      else
      {%>
      <div class="products-area-wrapper tableView">
        <div class="products-header">
          ...
          <div class="product-cell status-cell">Nombre de produit<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
          <div class="product-cell sales">Quantite<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
          <div class="product-cell stock">Etat<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
             <div class="product-cell stock">Prix Totale<button class="sort-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
              </svg>
            </button></div>
          ...
          <button class="cell-more-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical">
              ...
              <circle cx="12" cy="19" r="1" />
                 ...
                 <div class="product-cell category"><span class="cell-label">ID:</span><a href="gestionCom?id=<% out.println(p.getId());%>"><% out.println(p.getId());%></a></div>
          <div class="product-cell category"><span class="cell-label">userName:</span><% out.println(p.getUsername());%></div>
          
          <div class="product-cell sales"><span class="cell-label">Nombre des produits:</span><% out.println(p.getNombre());%></div>
          <div class="product-cell stock"><span class="cell-label">Quantite:</span><% out.println(p.getQte());%></div>
          <div class="product-cell price"><span class="cell-label">Etat:</span><% out.println(p.getEtat());%></div>
           <div class="product-cell price"><span class="cell-label">Totale:</span><% out.println(p.getPrixT());%>DH</div>
            <div class="product-cell price"><span class="cell-label">Date:</span><% out.println(p.getDate());%></div>
          <div class="product-cell status-cell">
            <span class="cell-label">Action:</span>
            <span class=""><ul><li>  <%out.println("<a href='gestionCom?ids="+p.getId()+"'>Suprimmer</a>");%></li>
<li>  <%out.println("<a href='gestionCom?idm="+p.getId()+"'>Modifier</a>");%></li></ul></span>
          </div>
        </div>
        <%} %>
      </div>
