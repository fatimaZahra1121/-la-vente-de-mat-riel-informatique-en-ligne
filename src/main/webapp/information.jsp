...
<%
  if(session.getAttribute("id")!=null)
  {
	...
	gestionUser m31=new gestionUser();
	if(m31.getIDadmin(idUser)==0)
	{
...
<ul>
  ...
  <li><a class="active" href="information.jsp"> Informations Personnelles</a> </li>
  <li><a href="adresse.jsp">Adresses</a></li>
  <li><a href="favoris.jsp">Favoris</a></li>
   <li><a href="deconnexion.jsp">Déconnexion </a></li>
</ul><h1  style="text-align:center;  ; "> Mes Informations Personnelles</h1>
<%--<h3 style="font-weight: 900;  position: absolute;  left:50px; text-decoration: underline;" >Mes Informations </h3>--%>

<table class="mytable-marg" id="customers"><th>IdClient</th>
    <th>Nom et Prenom</th>
    <th>Email</th>
    <th>Action</th>
  <tr> 
  ...
  <tr>
    <td><%out.print(id); %></td>
    <td><%out.print(nom); %></td>
    <td><%out.print(user.getMail()); %></td>
    <td> <a href='ModifierInfoClient?id=<%=id %>'><button class="app-content-headerButton">Modifier</button></a> </td>
  </tr> 
