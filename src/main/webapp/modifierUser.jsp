...
<body>
  ...
  <div class="app-container">
    ...
    <p>Material.Net</p>
      ...
      </ul></div>  <div class="form-container">
                    <h3 class="title">Modifier</h3>
            
                   <form  action="gestionuser" method="post" class="form-horizontal">
                        <div class="form-group">
                          ...
                          user p=new user();
                           String id=request.getParameter("id");
                    		...
                    		%>
                            <input type="text" name="user" class="form-control" placeholder="Email" value=<%=p.getMail() %>>
                        </div>
                        <div class="form-group">
                            <label>Password</label><br><br>
                            <input type="text" name="pass" class="form-control" placeholder="Password" value=<%=p.getPass() %>>
                        </div>
                        <br>                        <br>                        <br>
                        <div class="form-group">
